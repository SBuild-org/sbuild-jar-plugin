...
class SBuild(implicit _project: Project) {
  ...
  val namespace = "org.sbuild.plugins.jar"
  val version = "0.0.9000"
  val url = "https://github.com/SBuild-org/sbuild-jar-plugin"
  ...
  Plugin[MavenDeploy] configure (_.copy(
    ...
    version = version,
    artifactName = Some("SBuild Jar Plugin"),
    description = Some("An SBuild Plugin that supports creation of JAR files."),
